...
-- Function to handle new user signup - NOW WITH ZERO BALANCES
...
BEGIN
  ...
  -- Initialize balances for all currencies with ZERO
  ...
  -- NO sample transactions - users start with empty transaction history
