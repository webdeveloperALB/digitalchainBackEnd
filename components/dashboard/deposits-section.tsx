  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        ...
        <Button onClick={() => setShowDepositForm(true)} className="bg-[#F26623] hover:bg-[#E55A1F]">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <Select value={formData.method} onValueChange={(value) => setFormData({ ...formData, method: value })}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="Crypto Transfer">Crypto Transfer</SelectItem>
                </SelectContent>
              </Select>
            </div>
            ...
            <div className="flex gap-2">
              <Button onClick={submitDeposit} className="bg-[#F26623] hover:bg-[#E55A1F]">
          ...
          {deposits.length === 0 ? (
            ...
            <div className="space-y-4">
              {deposits.map((deposit) => (
                <div key={deposit.id} className="flex justify-between items-center p-4 border rounded-lg">
                  <div>
                    <p className="font-medium">
                      {Number(deposit.amount).toLocaleString()} {deposit.currency}
                    </p>
                    <p className="text-sm text-gray-600">{deposit.method}</p>
                    <p className="text-xs text-gray-500">Ref: {deposit.reference_id}</p>
