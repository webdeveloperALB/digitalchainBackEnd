          ...
          <DialogContent className="max-w-sm sm:max-w-md">
            <DialogHeader>
              ...
              <DialogDescription className="text-center text-sm sm:text-base text-gray-600 mt-4">
                ...
                <br />
                <br />
                As part of our regulatory compliance and risk management
                framework, we are required to limit loan services to Panamanian
            ...
            <div className="mt-6">
              <Alert className="border-amber-200 bg-amber-50">
                ...
                <AlertDescription className="text-amber-800">
                  Our lending services comply with Panamanian banking
                  regulations and are currently restricted to local residents.
                  We appreciate your understanding and encourage you to explore
                  our other banking services available to international clients.
                </AlertDescription>
              </Alert>
            </div>
