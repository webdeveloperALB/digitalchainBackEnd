              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <h3 className="text-lg font-semibold text-amber-900 mb-2">
                    You have {pendingRequests.length} pending crypto funding{" "}
                  ...
                  <p className="text-sm text-amber-800 mt-3">
                    Your previous requests are being processed. You can submit a
          ...
          <div className="max-w-2xl mx-auto">
            <div className="bg-white rounded-2xl p-12 text-center">
              ...
              <p className="text-lg text-gray-600 mb-8">
                Your deposit request has been received and is currently being
                processed. This typically takes between 15-30 minutes depending
                on network confirmation times.
              </p>
              <div className="bg-gray-50 rounded-lg p-6 mb-8 text-left">
                ...
                <ul className="space-y-2 text-gray-600">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Your transaction will be confirmed on the blockchain
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#F26623] mt-1">•</span>
                    <span>
                      You will receive an email notification once the funds are
                      credited
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#F26623] mt-1">•</span>
                    <span>
                      Your account balance will be updated automatically
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-gray-100 rounded-2xl p-8 md:p-12">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    >
                      I am aware that transactions on the blockchain can not be
                      reversed, and I am responsible for using the correct
                      information.
                    </label>
                  </div>
