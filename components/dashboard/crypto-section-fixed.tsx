  ...
  return (
    <div className="h-full overflow-y-auto">
      <div className="p-6 space-y-6 relative min-h-full">
        {/* Floating Notifications - Using portal approach */}
                ...
                <div className="animate-in slide-in-from-right duration-300 pointer-events-auto">
                  <Alert className="border-green-200 bg-green-50 shadow-lg">
                    ...
                    <AlertDescription className="text-green-800">
                      ...
                      <br />
                      Your crypto transfer request has been received and is
          ...
          <CardContent>
            {cryptoTransactions.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-500 text-lg">No crypto transfers yet</p>
