          ...
          <CardHeader>
            <CardTitle className="flex items-center justify-between">
              ...
              <Button
                ...
                size="sm"
                onClick={() =>
                  setShowAssignmentInterface(!showAssignmentInterface)
                }
              >
                <Settings className="w-4 h-4 mr-2" />
                {showAssignmentInterface ? "Hide" : "Show"} Assignment Tools
              </Button>
            </CardTitle>
          </CardHeader>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    {assignableUsers.length} users available for assignment
                  </p>
                </div>
              </div>
              <Button
