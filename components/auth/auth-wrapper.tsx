      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center max-w-md mx-auto p-6">
          ...
          <div className="space-y-2">
            ...
            <button onClick={signOut} className="block w-full text-[#F26623] hover:text-[#E55A1F] font-medium py-2">
              Sign In Again
            </button>
          </div>
        </div>
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        ...
        <div className="text-center max-w-md mx-auto p-6">
          ...
          <button onClick={signOut} className="text-[#F26623] hover:text-[#E55A1F] font-medium">
            Sign Out
          </button>
        </div>
      </div>
